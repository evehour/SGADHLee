...
void Shader::Pass::Dispatch(UINT ThreadGroupCountX, UINT ThreadGroupCountY, UINT ThreadGroupCountZ)
{
	BeginDraw();
	{
...
void Shader::Technique::Dispatch(UINT pass, UINT ThreadGroupCountX, UINT ThreadGroupCountY, UINT ThreadGroupCountZ)
{
	Passes[pass].Dispatch(ThreadGroupCountX, ThreadGroupCountY, ThreadGroupCountZ);
}
...
{
	techniques[technique].Passes[pass].Dispatch(ThreadGroupCountX, ThreadGroupCountY, ThreadGroupCountZ);
}
