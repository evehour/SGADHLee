...
#include "./Executes/TestTessTriangleDistance.h"
#include "./Executes/TestTessRect.h"
#include "./Executes/TestTessRectDistance.h"
...
Program::Program()
{
	...
	executes.push_back(new TestTessRectDistance());
}
