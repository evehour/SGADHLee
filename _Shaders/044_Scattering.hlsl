...
Texture2D StarfieldMap : register(t12);
SamplerState StarfieldSampler : register(s12);
...
float4 PS_Scattering(PixelInput input) : SV_TARGET
{
    ...
    float4 starField = saturate(StarfieldMap.Sample(StarfieldSampler, input.Uv) * StarIntensity);
