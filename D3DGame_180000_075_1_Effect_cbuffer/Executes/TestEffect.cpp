...
{
	shader1 = new Shader(Shaders + L"052_effect4.fx");

	_buffer.PlusPos = D3DXVECTOR4(2, 0, 0, 0);
	_buffer.PlusColor = D3DXVECTOR3(0, 1, 0);

	cbuffer = new CBuffer(shader1, "CB_PPOS", &_buffer, sizeof(_Buffer));
