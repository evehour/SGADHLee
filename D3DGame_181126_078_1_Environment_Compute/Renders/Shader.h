...
private:
	struct Pass
	{
		...
		void Dispatch(UINT ThreadGroupCountX, UINT ThreadGroupCountY, UINT ThreadGroupCountZ, bool UseHeader = true);
	...
	struct Technique
	{
		...
		void Dispatch(UINT pass, UINT ThreadGroupCountX, UINT ThreadGroupCountY, UINT ThreadGroupCountZ, bool UseHeader = true);
	};
