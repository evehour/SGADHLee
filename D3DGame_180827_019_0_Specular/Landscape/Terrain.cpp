...
{
	D3DXVECTOR3 start;
	RenderSettings::MainCamera()->Position(&start);

	D3DXVECTOR3 direction = RenderSettings::MainCamera()->Direction
	(
		RenderSettings::MainViewport(), RenderSettings::MainProjection()
	);
