...
public:
	Shader(wstring file, bool UseHeader = true);
	~Shader();
	...
	void Apply(UINT technique, UINT pass, bool bCS = false);
...
private:
	struct Pass
	{
		...
		void Dispatch(UINT ThreadGroupCountX, UINT ThreadGroupCountY, UINT ThreadGroupCountZ, bool UseHeader);
	...
	struct Technique
	{
		...
		void Dispatch(UINT pass, UINT ThreadGroupCountX, UINT ThreadGroupCountY, UINT ThreadGroupCountZ, bool UseHeader);
	};
