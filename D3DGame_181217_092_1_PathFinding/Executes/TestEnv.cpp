...
TestEnv::TestEnv()
{
	...
	rtv = new RenderTargetView((UINT)desc.Width, (UINT)desc.Height, DXGI_FORMAT_R8G8B8A8_UNORM);
	rtv2 = new RenderTargetView((UINT)desc.Width, (UINT)desc.Height, DXGI_FORMAT_R8G8B8A8_UNORM);

	blur = new Blur(Shaders + L"058_Blur.fx", (UINT)desc.Width, (UINT)desc.Height, DXGI_FORMAT_R8G8B8A8_UNORM, 2);
