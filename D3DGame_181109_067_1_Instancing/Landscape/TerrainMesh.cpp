...
TerrainMesh::TerrainMesh(ExecuteValues * values)
	: values(values)
{
...
void TerrainMesh::CopyVertices(void * vertices)
{
	memcpy(vertices, this->vertices, sizeof(VertexTextureNormal) * vertexCount);
}

void TerrainMesh::ReadHeightMap(wstring file)
{
...
void TerrainMesh::CalcNormalVector()
{
...
void TerrainMesh::AlignVertexData()
{
