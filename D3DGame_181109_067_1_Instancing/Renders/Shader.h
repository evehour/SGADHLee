...
public:
	...
	void CreateGSWithSO(D3D11_SO_DECLARATION_ENTRY* pDecl, UINT countDecl, string func = "GS");

	wstring GetFile() { return shaderFile; }

	void Render(bool renderVS = true, bool renderGS = true, bool renderPS = true);
