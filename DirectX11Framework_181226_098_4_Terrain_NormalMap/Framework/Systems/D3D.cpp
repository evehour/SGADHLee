...
#if defined(_DEBUG)
#define __D3D_DEVICE_DEBUG_MODE__
...
{
#ifdef _DEBUG
#ifdef __D3D_DEVICE_DEBUG_MODE__
	ID3D11Debug* debugDevice = nullptr;

	HRESULT hr = D3D::GetDevice()->QueryInterface(__uuidof(ID3D11Debug), (void**)&debugDevice);
	assert(SUCCEEDED(hr));

	hr = debugDevice->ReportLiveDeviceObjects(D3D11_RLDO_DETAIL/*D3D11_RLDO_SUMMARY*/);
